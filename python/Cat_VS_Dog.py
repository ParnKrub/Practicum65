...
ARROW = pygame.transform.scale(pygame.image.load(
    os.path.join('Assets', 'Arrow.png')), (ARROW_LENGTH, ARROW_WIDTH))
...
GURA_SPIN1 = pygame.transform.scale(pygame.image.load(
    os.path.join('Assets', 'spin1.png')), (PLAYER_WIDTH, PLAYER_HEIGHT))
GURA_SPIN2 = pygame.transform.scale(pygame.image.load(
    os.path.join('Assets', 'spin2.png')), (PLAYER_WIDTH, PLAYER_HEIGHT))
GURA_SPIN3 = pygame.transform.scale(pygame.image.load(
    os.path.join('Assets', 'spin3.png')), (PLAYER_WIDTH, PLAYER_HEIGHT))
GURA_SPIN4 = pygame.transform.scale(pygame.image.load(
    os.path.join('Assets', 'spin4.png')), (PLAYER_WIDTH, PLAYER_HEIGHT))
GURA_SPIN5 = pygame.transform.scale(pygame.image.load(
    os.path.join('Assets', 'spin5.png')), (PLAYER_WIDTH, PLAYER_HEIGHT))
GURA_SPIN6 = pygame.transform.scale(pygame.image.load(
    os.path.join('Assets', 'spin6.png')), (PLAYER_WIDTH, PLAYER_HEIGHT))
GURA_SPIN7 = pygame.transform.scale(pygame.image.load(
    os.path.join('Assets', 'spin7.png')), (PLAYER_WIDTH, PLAYER_HEIGHT))
GURA_SPIN8 = pygame.transform.scale(pygame.image.load(
    os.path.join('Assets', 'spin8.png')), (PLAYER_WIDTH, PLAYER_HEIGHT))
GURA_SPIN9 = pygame.transform.scale(pygame.image.load(
    os.path.join('Assets', 'spin9.png')), (PLAYER_WIDTH, PLAYER_HEIGHT))
GURA_SPIN10 = pygame.transform.scale(pygame.image.load(
    os.path.join('Assets', 'spin10.png')), (PLAYER_WIDTH, PLAYER_HEIGHT))
GURA_SPIN11 = pygame.transform.scale(pygame.image.load(
    os.path.join('Assets', 'spin11.png')), (PLAYER_WIDTH, PLAYER_HEIGHT))
GURA_SPIN12 = pygame.transform.scale(pygame.image.load(
    os.path.join('Assets', 'spin12.png')), (PLAYER_WIDTH, PLAYER_HEIGHT))
...
def find_power(light, light_min, light_max):
    if light > light_max:
        power = 450
    elif light < light_min:
        power = 0
    else:
        power = ((light-light_min)/(light_max-light_min))*600
    return power


def find_angle(light, light_min, light_max):
    if light > light_max:
...
def main():
    ...
    while(True):
        if(peri.get_switch()):
            ...
            break
    while(peri.get_switch()):
        continue
    while(peri.get_switch()):
        continue
    print("lightmin=", light_min)
    ...
    while run:
        ...
        if not shoot:
            while(True):
                ...
                if not angset:
                    angle = find_angle(light, light_min, light_max)
                    line[1] = (200*math.cos(angle), 200*math.sin(angle))
                elif not shoot:
                    power = find_power(
                        light, light_min, light_max)/POWER_FACTOR
                    line[1] = (power*math.cos(angle), power*math.sin(angle))
